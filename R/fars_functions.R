...
#' @export
xfars_read_years <- function(years) {
...
xfars_summarize_years <- function(years) {
...
#'   representions or if the indicated packages are not attached.
#' @export
xfars_map_state <- function(state.num, year) {
